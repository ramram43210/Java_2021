...
public interface UserRepository extends PagingAndSortingRepository<UserEntity, Long>
{
	...
	List<Object[]> getFullNamebyUserId(@Param("userId") String userId);
	
	@Transactional
	@Modifying
	@Query("Update UserEntity user set user.emailVerificationToken=:token WHERE email=:emailId")
	void updateUserEmailVerificationToken(@Param("token") String token,@Param("emailId") String emailId);
