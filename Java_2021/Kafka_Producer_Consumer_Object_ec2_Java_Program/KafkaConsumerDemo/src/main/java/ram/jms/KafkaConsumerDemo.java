...
public class KafkaConsumerDemo
{
	...
	public static void main(String[] args)
	{
		...
		properties.setProperty(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "ec2-3-86-232-67.compute-1.amazonaws.com:8082");
		properties.setProperty(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class.getName());
		properties.setProperty(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, "ram.util.CustomDeserializer");
		properties.setProperty(ConsumerConfig.GROUP_ID_CONFIG, "Group99");
		properties.setProperty(ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, "earliest");
		// create consumer
		KafkaConsumer<String, Animal> consumer = new KafkaConsumer<>(properties);
		...
		try
		{
			...
			while (true)
			{
				ConsumerRecords<String, Animal> ConsumerRecords = consumer.poll(Duration.ofMillis(100));
